...
public enum ExhibitionCode {
    ...
    PLEASE_ENTER_THE_NAME_EXHIBITION("BO_PD_AL_008","전시코너명을 입력해주세요."),
    REGISTER_IMAGE_EXHIBITION_CORNER("BO_PD_AL_009", "전시코너명에 노출할 이미지를 등록해주세요."),
    DATE_AND_TIME("BO_PD_AL_010", "전시기간 및 일시를 입력해주세요."),
    END_DATE_OF_EXHIBITION_CANNOT_EARLIER_START_DATE("BO_PD_AL_011", "전시기간의 종료일이 시작일보다 빠를 수 없습니다."),
