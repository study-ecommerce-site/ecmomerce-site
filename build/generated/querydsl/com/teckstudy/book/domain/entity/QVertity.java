...
public class QVertity extends EntityPathBase<Vertity> {
    ...
    private static final long serialVersionUID = -1643432446L;
    ...
    public final EnumPath<com.teckstudy.book.domain.entity.enums.YesNoStatus> auth_yn = createEnum("auth_yn", com.teckstudy.book.domain.entity.enums.YesNoStatus.class);

    public final QMember member;

    public final EnumPath<com.teckstudy.book.domain.entity.enums.AuthType> member_auth_type = createEnum("member_auth_type", com.teckstudy.book.domain.entity.enums.AuthType.class);
