...
public class QBookOrder extends EntityPathBase<BookOrder> {
    ...
    private static final long serialVersionUID = -281191212L;
    ...
    public final EnumPath<com.teckstudy.book.entity.enums.OrderStatus> order_status = createEnum("order_status", com.teckstudy.book.entity.enums.OrderStatus.class);

    public final EnumPath<com.teckstudy.book.entity.enums.YesNoStatus> order_yn = createEnum("order_yn", com.teckstudy.book.entity.enums.YesNoStatus.class);
